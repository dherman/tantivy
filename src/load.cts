...
module.exports = require('@neon-rs/load').proxy({
  platforms: {
    'win32-x64-msvc': () => require('@tantivy/win32-x64-msvc'),
    'darwin-x64': () => require('@tantivy/darwin-x64'),
    'darwin-arm64': () => require('@tantivy/darwin-arm64'),
    'linux-x64-gnu': () => require('@tantivy/linux-x64-gnu'),
    'linux-arm64-gnu': () => require('@tantivy/linux-arm64-gnu')
  },
